...
const EditForm = (props: Props) => {
    ...
    const formSubmit = () => {
        axios.patch(`http://localhost:4002/restfulapi/student/${props.index}`,oldData, {withCredentials: true})
            .then(res => console.log(res.data))
            .catch(err => console.log(err))
    }
    useEffect(() => {
        console.log(props.index)
        axios.get(`http://localhost:4002/restfulapi/student/${props.index}`, {withCredentials: true})
            .then(res => {
